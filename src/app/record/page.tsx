...
import {
  useWorkoutDraft,
  createBlock,
  createBlockWithExercise,
  createBlockFromEntry,
  type ExerciseBlock,
} from "@/components/WorkoutDraftContext";
...
export default function RecordWorkoutPage() {
  ...
  const { date, setDate, blocks, setBlocks, clearDraft } = useWorkoutDraft();
  ...
  return (
    <div className="flex flex-1 flex-col p-4">
      <div className="mb-4 flex items-center justify-between">
        <h1 className="text-xl font-bold">Registrar entreno</h1>
        <button
